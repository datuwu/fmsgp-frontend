...
import { ICreateTempWarehouseRequestDto, temWareHouseRequestApi } from '@/core/api/temp-warehouse-request.api';
...
const Page = () => {
    ...
    const { id, purchasingStaffId, isInspector, isPurchasingStaff } = useSelector<RootState, UserState>((state) => state.user);
    ...
    useDocumentTitle('Add Temp Warehouse Request');
    ...
    return (
        <div className="fade-in flex w-full gap-4">
            <div className=" flex flex-1 flex-col gap-2">
                <FormBuilder<ICreateTempWarehouseRequestDto>
                    apiAction={temWareHouseRequestApi.create}
                    defaultValues={{
                        purchasingOrderId: 0,
                        deliveryStageId: 0,
                    ...
                    title="Add Temp Warehouse Request"
                    ...
                    fields={[
                        ...
                        },
                        {
                            ...
                            isShowField: (form: ICreateTempWarehouseRequestDto) => form.purchasingOrderId !== 0,
                            type: NKFormType.SELECT_API_OPTION,
                            fieldProps: {
                                apiAction: async (value, formMethods) => {
                                    const form = formMethods.getValues() as ICreateTempWarehouseRequestDto;
                            ...
                            onChangeExtra(value, path, formMethods) {
                                ...
                                formMethods.setValue('requestExecutionDate', moment(deliveryStage?.deliveryDate).format('YYYY-MM-DDTHH:mm:ss'));
                            },
                        },
                        {
                            label: 'Request Date',
                        ...
                        },
                        {
                            ...
                            fieldProps: {
                                apiAction: isInspector
                                    ...
                                    : isPurchasingStaff
                                      ? temWareHouseRequestApi.getEnumPurchasingStaffType
...
export const Route = createFileRoute('/_admin-layout/dashboard/temp-warehouse-request/create')({
    component: Page,
});
