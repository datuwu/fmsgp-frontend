...
const Page: React.FunctionComponent<PageProps> = () => {
    ...
    useDocumentTitle('Main Warehouse Material List');

    return (
        <div>
            <div className="">
                <TableBuilder
                    sourceKey="main-warehouse-material"
                    title="Main Warehouse Material List"
                    extraButtons={[<></>]}
                    columns={[
                        {
                    ...
                    queryApi={warehouseMaterialApi.getAllMainWarehouse}
...
export const Route = createFileRoute('/_admin-layout/dashboard/warehouse-material/')({
    component: Page,
});
